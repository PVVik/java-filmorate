...
public class FilmStorageTest {
    ...
    public void addFilm_shouldAddFilmWithCorrectData() {
        Film addedFilm = filmStorage.addFilm(rightFilm);
    ...
    public void updateFilm_shouldUpdateName() {
        filmStorage.addFilm(rightFilm);
        Film film = filmStorage.updateFilm(Film.builder().id(1).name("newName").build());
    ...
    public void updateFilm_shouldUpdateDescription() {
        filmStorage.addFilm(rightFilm);
        Film film = filmStorage.updateFilm(Film.builder().id(1).description("newDescription").build());
    ...
    public void updateFilm_shouldUpdateReleaseDate() {
        filmStorage.addFilm(rightFilm);
        Film film = filmStorage.updateFilm(Film.builder().id(1)
    ...
    public void updateFilm_shouldUpdateDuration() {
        filmStorage.addFilm(rightFilm);
        Film film = filmStorage.updateFilm(Film.builder().id(1).duration(10L).build());
    ...
    public void getFilms_shouldGetEmptyList() {
        Assertions.assertEquals(0, filmStorage.getFilms().size());
    }
    ...
    public void getFilms_shouldGetList() {
        filmStorage.addFilm(rightFilm);
        filmStorage.addFilm(Film.builder().name("name2").description("des")
